 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * public void setShipment_id(String shipment_id) { this.shipment_id =
		 * shipment_id; }
		 * 
		 * public String getOrder_line_id() { return order_line_id; }
		 * 
		 * public void setOrder_line_id(String order_line_id) { this.order_line_id =
		 * order_line_id; }
		 * 
		 ...
		 * 
		 * public void setPayment_mode(String payment_mode) { this.payment_mode =
		 * payment_mode; }
		 * 
		 * @Override public String toString() { return "WmsOrderLines [order_id=" +
		 * order_id + ", shipment_id=" + shipment_id + ", order_line_id=" +
